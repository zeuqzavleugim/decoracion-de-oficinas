...
export default function GaleFloorGrafic(params) {
    return(
        <>
            <Head title="Floor Graphic | Gráficos Personalizados"/>
            <Nav/>
            <div className="colorGr">
                <h1 className="divCenter h1">FloorGraphic</h1>
                <h2 className="divCenter h4">
                    Nuestra galeria de proyectos
                </h2>
            </div>
            <div className="galeria">
                {GaleriaFloorGrafic.map((item, index) => (
