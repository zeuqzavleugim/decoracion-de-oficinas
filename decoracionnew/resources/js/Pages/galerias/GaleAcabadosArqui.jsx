...
export default function GaleAcabadosArqui(params) {
    return(
        <>
            <Head title="Soluciones Decorativas de Alta Calidad"/>
            <Nav/>
            <div className="colorGr">
                <h1 className="divCenter h1">Acabados Arquitectónicos</h1>
                <h2 className="divCenter h4">
                    Nuestra galeria de proyectos
                </h2>
            </div>
            <div className="galeria">
                {GaleriaAcabadosArqui.map((item, index) => (
