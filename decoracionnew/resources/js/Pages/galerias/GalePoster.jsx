...
import { GaleriaPoster } from "@/Imags/GaleriaPoster";
import { UsoGeneral } from "@/Imags/UsoGeneral";
import Form from "@/Layouts/Form";

export default function GalePoster(params) {
    return(
        <>
            <Head title="Posters | Impresión de Alta Calidad"/>
            <Nav/>
            <div className="colorGr">
                <h1 className="divCenter h1">Posters</h1>
                <h2 className="divCenter h4">
                    Nuestra galeria de los proyectos
                </h2>
            </div>
            <div className="galeria">
                {GaleriaPoster.map((item, index) => (
