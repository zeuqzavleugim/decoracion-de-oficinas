...
export default function GaleRecorteVinilTextil(params) {
    return(
        <>
            <Head title="Personalización de Ropa y Textiles"/>
            <Nav/>
            <div className="colorGr">
                <h1 className="divCenter h1">Recorte de Vinil Textil</h1>
                <h2 className="divCenter h4">
                    Nuestra galeria de los proyectos
                </h2>
            </div>
            <div className="galeria">
                {GaleriaRecorteVinilTextil.map((item, index) => (
