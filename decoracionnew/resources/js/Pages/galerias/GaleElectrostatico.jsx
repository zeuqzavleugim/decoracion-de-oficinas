...
export default function GaleElectrostatico(params) {
    return(
        <>
            <Head title="Vinil Electrostático | Soluciones"/>
            <Nav/>
            <div className="colorGr">
                <h1 className="divCenter h1">Vinil Electrostatico</h1>
                <h2 className="divCenter h4">
                    Nuestra galeria de proyectos
                </h2>
            </div>
            <div className="galeria">
                {GaleriaElectrostatico.map((item, index) => (
