...
export default function GaleRotulacionVehiculos(params) {
    return(
        <>
            <Head title="Personalización y Publicidad Móvil"/>
            <Nav/>
            <div className="colorGr">
                <h1 className="divCenter h1">Rotulación de Vehículos Personalizado</h1>
                <h2 className="divCenter h4">
                    Nuestra galeria de proyectos
                </h2>
            </div>
            <div className="galeria">
                {GaleriaRotulacionVehiculos.map((item, index) => (
